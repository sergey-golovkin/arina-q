...
BEGIN
   ...
   SELECT BLOB2CLOB(UTL_COMPRESS.LZ_UNCOMPRESS(DATA_VALUE)) DATA_VALUE, META_INFO, EXPIRE_DATE INTO V_DATA_VALUE, V_META_INFO, V_EXPIRE_DATE FROM DATA_IN_MSG WHERE MSG_ID = V_MSG_ID;
...
BEGIN
   ...
   SELECT BLOB2CLOB(UTL_COMPRESS.LZ_UNCOMPRESS(DATA_VALUE)) DATA_VALUE, META_INFO, EXPIRE_DATE INTO V_DATA_VALUE, V_META_INFO, V_EXPIRE_DATE FROM DATA_OUT_MSG WHERE MSG_ID = V_MSG_ID;
...
BEGIN
  ...
  INSERT INTO DATA_OUT_MSG(MSG_ID, DATA_VALUE, META_INFO, EXPIRE_DATE) VALUES (V_MSG_ID, UTL_COMPRESS.LZ_COMPRESS(CLOB2BLOB(P_DATA_VALUE), 9), P_META_INFO, P_EXPIRE_DATE);
...
BEGIN
  BEGIN
    ...
    INSERT INTO DATA_IN_MSG(MSG_ID, DATA_VALUE, META_INFO, EXPIRE_DATE) VALUES (V_MSG_ID, UTL_COMPRESS.LZ_COMPRESS(CLOB2BLOB(P_DATA_VALUE), 9), P_META_INFO, P_EXPIRE_DATE);
